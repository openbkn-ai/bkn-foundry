...
class Config:
    HOST = _env("AGENT_RUNTIME_HOST", "0.0.0.0")
    PORT = int(_env("AGENT_RUNTIME_PORT", "30800"))
    ...
    DEFAULT_MODEL = _env("AGENT_RUNTIME_DEFAULT_MODEL", "")
    ...
    DEFAULT_MAX_TURNS = int(_env("AGENT_RUNTIME_MAX_TURNS", "25"))
    DEFAULT_TIMEOUT_S = int(_env("AGENT_RUNTIME_TIMEOUT_S", "300"))

    SKILL_CACHE_TTL_S = int(_env("AGENT_RUNTIME_SKILL_TTL", "60"))
