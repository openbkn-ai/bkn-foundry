...
//go:embed data/authorization-catalog.json
...
// validateHierarchy checks the type-level hierarchy declared in authorization-catalog.json:
...
// authorization-catalog.json: every requirement is declared on the same type, is not the
