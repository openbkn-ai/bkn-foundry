...
BKN Foundry 的 **场景化操作手册**：每篇是一段「**一目标 / 一组命令 / 一段输出**」的可复制教程。
...
| Recipe | 一句话目标 |
| --- | --- |
| [从 CSV 一键建知识网络](./cookbook_example.md) | 用 `openbkn bkn create-from-csv` 把若干 CSV 一次性变成可查询的 KN |
...
2. **Prerequisites**：版本 / 已登录 / 账号上下文 / 本篇特有依赖
