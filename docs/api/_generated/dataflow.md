...
curl -X GET https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id} \
  -H 'Accept: application/json'

```

```http
GET https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id} HTTP/1.1
...
fetch('https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}',
{
  method: 'GET',
...
result = RestClient.get 'https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}',
  params: {
  }, headers: headers
...
r = requests.get('https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}', headers = headers)
...
try {
    $response = $client->request('GET','https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}");
...
func main() {
    ...
    req, err := http.NewRequest("GET", "https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X PUT https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id} \
...
```http
PUT https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id} HTTP/1.1
...
result = RestClient.put 'https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}',
  params: {
  }, headers: headers
...
r = requests.put('https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}', headers = headers)
...
try {
    $response = $client->request('PUT','https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PUT", "https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X DELETE https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id} \
  -H 'Accept: application/json'

```

```http
DELETE https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id} HTTP/1.1
...
result = RestClient.delete 'https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}',
  params: {
  }, headers: headers
...
r = requests.delete('https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}', headers = headers)
...
try {
    $response = $client->request('DELETE','https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("DELETE", "https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X PUT https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
PUT https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields} HTTP/1.1
...
fetch('https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields}',
{
  method: 'PUT',
  body: inputBody,
  headers: headers
...
result = RestClient.put 'https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields}',
  params: {
  }, headers: headers
...
r = requests.put('https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields}', headers = headers)
...
try {
    $response = $client->request('PUT','https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("PUT");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PUT", "https://{host}:{port}/api/sdp-pipeline/v1/pipelines/{pipeline_id}/attrs/{fields}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X GET https://{host}:{port}/api/sdp-pipeline/v1/pipelines \
  -H 'Accept: application/json'

```

```http
GET https://{host}:{port}/api/sdp-pipeline/v1/pipelines HTTP/1.1
...
fetch('https://{host}:{port}/api/sdp-pipeline/v1/pipelines',
{
  method: 'GET',
...
result = RestClient.get 'https://{host}:{port}/api/sdp-pipeline/v1/pipelines',
  params: {
  }, headers: headers
...
r = requests.get('https://{host}:{port}/api/sdp-pipeline/v1/pipelines', headers = headers)
...
try {
    $response = $client->request('GET','https://{host}:{port}/api/sdp-pipeline/v1/pipelines', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://{host}:{port}/api/sdp-pipeline/v1/pipelines");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://{host}:{port}/api/sdp-pipeline/v1/pipelines", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST https://{host}:{port}/api/sdp-pipeline/v1/pipelines \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
...
```http
POST https://{host}:{port}/api/sdp-pipeline/v1/pipelines HTTP/1.1
...
result = RestClient.post 'https://{host}:{port}/api/sdp-pipeline/v1/pipelines',
  params: {
  }, headers: headers
...
r = requests.post('https://{host}:{port}/api/sdp-pipeline/v1/pipelines', headers = headers)
...
try {
    $response = $client->request('POST','https://{host}:{port}/api/sdp-pipeline/v1/pipelines', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://{host}:{port}/api/sdp-pipeline/v1/pipelines", data)
    req.Header = headers
