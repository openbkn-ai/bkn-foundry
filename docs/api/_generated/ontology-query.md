...
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id} \
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id} HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}");
...
func main() {
    ...
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'x-http-method-override: GET'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id} HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'x-http-method-override: GET'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/subgraph/objects", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'x-http-method-override: GET'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/object-types/{ot_id}/properties", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/action-types/{at_id}/execute", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X GET /api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id} \
  -H 'Accept: application/json'

```

```http
GET /api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id} HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id}',
{
  method: 'GET',
...
result = RestClient.get '/api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id}',
  params: {
  }, headers: headers
...
r = requests.get('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id}', headers = headers)
...
try {
    $response = $client->request('GET','/api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "/api/ontology-query/v1/knowledge-networks/{kn_id}/action-executions/{execution_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X GET /api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs \
  -H 'Accept: application/json'

```

```http
GET /api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs',
{
  method: 'GET',
...
result = RestClient.get '/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs',
  params: {
  }, headers: headers
...
r = requests.get('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs', headers = headers)
...
try {
    $response = $client->request('GET','/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X GET /api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id} \
  -H 'Accept: application/json'

```

```http
GET /api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id} HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}',
{
  method: 'GET',
...
result = RestClient.get '/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}',
  params: {
  }, headers: headers
...
r = requests.get('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}', headers = headers)
...
try {
    $response = $client->request('GET','/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/action-logs/{log_id}/cancel", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/{metric_id}/data", data)
    req.Header = headers
...
```shell
# You can also use wget
curl -X POST /api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
POST /api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run HTTP/1.1
...
fetch('/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
result = RestClient.post '/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run',
  params: {
  }, headers: headers
...
r = requests.post('/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run', headers = headers)
...
try {
    $response = $client->request('POST','/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "/api/ontology-query/v1/knowledge-networks/{kn_id}/metrics/dry-run", data)
    req.Header = headers
