...
# Trace Admission material is supplied by the installer, never generated by
...
bkn_backend_string_sets="${CORE_RELEASE_EXTRA_SET_STRINGS[*]:-}"
...
contains "bkn-backend wires Trace Admission client ID" "${bkn_backend_string_sets}" "bknTrace.evidencePublisher.traceAdmission.clientID=test-publisher"
not_contains "bkn-backend has no static policy revision" "${bkn_backend_sets}${bkn_backend_string_sets}" "capturePolicyRevision="
...
ontology_query_string_sets="${CORE_RELEASE_EXTRA_SET_STRINGS[*]:-}"
...
contains "ontology-query wires Trace Admission client ID" "${ontology_query_string_sets}" "bknTrace.evidencePublisher.traceAdmission.clientID=test-publisher"
not_contains "ontology-query has no static policy revision" "${ontology_query_sets}${ontology_query_string_sets}" "capturePolicyRevision="
...
saved_trace_admission_client_id="${OPENBKN_TRACE_ADMISSION_CLIENT_ID}"
saved_trace_admission_secret="${OPENBKN_TRACE_ADMISSION_CLIENT_SECRET_SECRET_NAME}"
saved_trace_admission_key_id="${OPENBKN_TRACE_ADMISSION_CURRENT_KEY_ID}"
saved_trace_admission_public_key="${OPENBKN_TRACE_ADMISSION_CURRENT_PUBLIC_KEY_SECRET_NAME}"
OPENBKN_TRACE_ADMISSION_CLIENT_ID=""
OPENBKN_TRACE_ADMISSION_CLIENT_SECRET_SECRET_NAME=""
OPENBKN_TRACE_ADMISSION_CURRENT_KEY_ID=""
OPENBKN_TRACE_ADMISSION_CURRENT_PUBLIC_KEY_SECRET_NAME=""
CORE_RELEASE_EXTRA_SETS=()
CORE_RELEASE_EXTRA_SET_STRINGS=()
_openbkn_release_extra_sets bkn-backend openbkn
