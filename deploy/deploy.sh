...
usage() {
    ...
    echo "  --latest                      Follow newest main builds instead of the newest release manifest"
    echo "                                (default falls back to this only when no usable release exists)."
    ...
    echo "  $0 bkn-foundry install --registry=swr           # Default: newest release manifest (fallback: newest main builds)"
