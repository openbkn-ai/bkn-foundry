...
func TestControlClientSendsFrozenHeartbeatAndAck(t *testing.T) {
	...
	client := &http.Client{Transport: roundTripFunc(func(request *http.Request) (*http.Response, error) {
		...
		case 2:
			...
			if got, want := string(body), `{"producer_instance_id":"spiffe://cluster.local/ns/openbkn/sa/bkn-backend#boot-1","capture_policy_revision":42,"last_accepted_sequence":7,"published":5,"dropped":2,"queue_empty":true,"acknowledged_at":"2026-09-25T08:00:00Z"}`; got != want {
