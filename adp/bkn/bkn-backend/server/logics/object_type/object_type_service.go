...
func (ots *objectTypeService) GetObjectTypesByIDs(ctx context.Context, tx *sql.Tx,
	...
	if err = ots.ps.CheckPermission(ctx, resource, []string{interfaces.OPERATION_TYPE_VIEW_DETAIL}); err != nil {
		return nil, err
	}
...
func (ots *objectTypeService) UpdateObjectType(ctx context.Context, tx *sql.Tx, objectType *interfaces.ObjectType, strictMode bool) error {
	...
	err = ots.ps.CheckPermission(ctx,
		interfaces.KNChildPermissionResource(interfaces.RESOURCE_TYPE_OBJECT_TYPE,
