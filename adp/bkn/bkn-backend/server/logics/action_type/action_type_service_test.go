...
func allowAllActionPermissionResources(_ context.Context, _ string, ids, _ []string) (map[string]interfaces.PermissionResourceOps, error) {
...
func Test_actionTypeService_ListActionTypes(t *testing.T) {
	Convey("Test ListActionTypes\n", t, func() {
		...
		Convey("Success listing action types\n", func() {
			...
			ata.EXPECT().ListActionTypes(gomock.Any(), listQuery).Return(atArr, nil)
...
func Test_actionTypeService_DeleteActionTypesByIDs(t *testing.T) {
	Convey("Test DeleteActionTypesByIDs\n", t, func() {
		...
		Convey("Success deleting action types\n", func() {
			...
			actionTypes := []*interfaces.ActionType{
				{ActionTypeWithKeyField: interfaces.ActionTypeWithKeyField{ATID: "at1"}},
				{ActionTypeWithKeyField: interfaces.ActionTypeWithKeyField{ATID: "at2"}},
			}
			ata.EXPECT().GetActionTypesByIDs(gomock.Any(), knID, branch, atIDs).Return(actionTypes, nil)
			smock.ExpectBegin()
