...
func allowAllRelationPermissionResources(_ context.Context, _ string, ids, _ []string) (map[string]interfaces.PermissionResourceOps, error) {
...
func Test_relationTypeService_DeleteRelationTypesByKnID(t *testing.T) {
	Convey("Test DeleteRelationTypesByKnID\n", t, func() {
		...
		ps.EXPECT().DeleteResources(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil).AnyTimes()
		ps.EXPECT().DeleteResourceParents(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil).AnyTimes()
		service := &relationTypeService{appSetting: &common.AppSetting{}, rta: rta, ps: ps}
