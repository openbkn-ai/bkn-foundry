...
func (m *MockKNAccess) ListAuthorizationResources(ctx context.Context, query interfaces.AuthorizationResourcesQuery) ([]*interfaces.AuthorizationResource, int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockKNAccessMockRecorder) ListAuthorizationResources(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAuthorizationResources", reflect.TypeOf((*MockKNAccess)(nil).ListAuthorizationResources), ctx, query)
}
