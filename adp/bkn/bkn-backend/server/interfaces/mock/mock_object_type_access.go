...
func (mr *MockObjectTypeAccessMockRecorder) ListObjectTypeSummaries(ctx, tx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListObjectTypeSummaries", reflect.TypeOf((*MockObjectTypeAccess)(nil).ListObjectTypeSummaries), ctx, tx, query)
}
