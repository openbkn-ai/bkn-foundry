...
func (m *MockActionTypeAccess) ListActionTypeSummaries(ctx context.Context, query interfaces.ActionTypesQueryParams) ([]*interfaces.ActionType, error) {
	m.ctrl.T.Helper()
...
func (mr *MockActionTypeAccessMockRecorder) ListActionTypeSummaries(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListActionTypeSummaries", reflect.TypeOf((*MockActionTypeAccess)(nil).ListActionTypeSummaries), ctx, query)
}
