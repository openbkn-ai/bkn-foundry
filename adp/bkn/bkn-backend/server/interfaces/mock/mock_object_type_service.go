...
func (m *MockObjectTypeService) ListObjectTypeSummaries(ctx context.Context, tx *sql.Tx, query interfaces.ObjectTypesQueryParams) ([]*interfaces.ObjectType, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListObjectTypeSummaries", ctx, tx, query)
	ret0, _ := ret[0].([]*interfaces.ObjectType)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
// ListObjectTypeSummaries indicates an expected call of ListObjectTypeSummaries.
func (mr *MockObjectTypeServiceMockRecorder) ListObjectTypeSummaries(ctx, tx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListObjectTypeSummaries", reflect.TypeOf((*MockObjectTypeService)(nil).ListObjectTypeSummaries), ctx, tx, query)
}
