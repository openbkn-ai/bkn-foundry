...
// Source: interfaces/drivenadapters.go
//
// Generated by this command:
//
//	mockgen -source interfaces/drivenadapters.go -destination mocks/drivenadapters.go -package mocks
//
...
// OperationChecks mocks base method.
func (m *MockAuthorization) OperationChecks(ctx context.Context, req *interfaces.AuthOperationChecksRequest) (*interfaces.AuthOperationChecksResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OperationChecks", ctx, req)
	ret0, _ := ret[0].(*interfaces.AuthOperationChecksResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// OperationChecks indicates an expected call of OperationChecks.
func (mr *MockAuthorizationMockRecorder) OperationChecks(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OperationChecks", reflect.TypeOf((*MockAuthorization)(nil).OperationChecks), ctx, req)
}
