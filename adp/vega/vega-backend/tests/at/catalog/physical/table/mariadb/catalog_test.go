...
func TestMariaDBCatalogDiscover(t *testing.T) {
	...
	Convey("MariaDB Catalog Discover AT测试 - 初始化", t, func() {
		...
		tableSourceMeta := map[string]any{
			"columns": []any{
				map[string]any{"name": "c_int", "type": "integer", "original_type": "int(11)", "nullable": false, "description": "", "num_precision": 10, "ordinal_position": 1, "column_key": "PRI"},
				map[string]any{"name": "c_int2", "type": "integer", "original_type": "int(11)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 10, "ordinal_position": 2, "column_key": "UNI"},
				map[string]any{"name": "c_bigint", "type": "integer", "original_type": "bigint(20)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 19, "ordinal_position": 3, "column_key": "MUL"},
				map[string]any{"name": "c_bigint2", "type": "integer", "original_type": "bigint(20)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 19, "ordinal_position": 4, "column_key": ""},
				map[string]any{"name": "c_smallint", "type": "integer", "original_type": "smallint(6)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 5, "ordinal_position": 5, "column_key": "MUL"},
				map[string]any{"name": "c_smallint2", "type": "integer", "original_type": "smallint(6)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 5, "ordinal_position": 6, "column_key": ""},
				map[string]any{"name": "c_tinyint", "type": "integer", "original_type": "tinyint(4)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 3, "ordinal_position": 7, "column_key": ""},
				map[string]any{"name": "c_tinyint2", "type": "integer", "original_type": "tinyint(4)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 3, "ordinal_position": 8, "column_key": ""},
				map[string]any{"name": "c_mediumint", "type": "integer", "original_type": "mediumint(9)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 7, "ordinal_position": 9, "column_key": ""},
				map[string]any{"name": "c_mediumint2", "type": "integer", "original_type": "mediumint(8)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 7, "ordinal_position": 10, "column_key": ""},
				map[string]any{"name": "c_decimal", "type": "decimal", "original_type": "decimal(10,2)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 10, "num_scale": 2, "ordinal_position": 11, "column_key": ""},
				map[string]any{"name": "c_float", "type": "float", "original_type": "float", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 12, "ordinal_position": 12, "column_key": ""},
				map[string]any{"name": "c_double", "type": "float", "original_type": "double", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 22, "ordinal_position": 13, "column_key": ""},
				map[string]any{"name": "c_char", "type": "string", "original_type": "char(10)", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 10, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 14, "column_key": ""},
				map[string]any{"name": "c_varchar", "type": "string", "original_type": "varchar(255)", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 255, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 15, "column_key": ""},
				map[string]any{"name": "c_text", "type": "text", "original_type": "text", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 65535, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 16, "column_key": ""},
				map[string]any{"name": "c_mediumtext", "type": "text", "original_type": "mediumtext", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 16777215, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 17, "column_key": ""},
				map[string]any{"name": "c_longtext", "type": "text", "original_type": "longtext", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 4294967295, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 18, "column_key": ""},
				map[string]any{"name": "c_date", "type": "date", "original_type": "date", "nullable": true, "default_value": "NULL", "description": "", "ordinal_position": 19, "column_key": ""},
				map[string]any{"name": "c_time", "type": "time", "original_type": "time", "nullable": true, "default_value": "NULL", "description": "", "ordinal_position": 20, "column_key": ""},
				map[string]any{"name": "c_datetime", "type": "datetime", "original_type": "datetime", "nullable": true, "default_value": "NULL", "description": "", "ordinal_position": 21, "column_key": ""},
				map[string]any{"name": "c_datetime2", "type": "datetime", "original_type": "datetime(6)", "nullable": true, "default_value": "NULL", "description": "", "datetime_precision": 6, "ordinal_position": 22, "column_key": ""},
				map[string]any{"name": "c_timestamp", "type": "datetime", "original_type": "timestamp", "nullable": true, "default_value": "current_timestamp()", "description": "", "ordinal_position": 23, "column_key": ""},
				map[string]any{"name": "c_timestamp2", "type": "datetime", "original_type": "timestamp(6)", "nullable": true, "default_value": "current_timestamp(6)", "description": "", "datetime_precision": 6, "ordinal_position": 24, "column_key": ""},
				map[string]any{"name": "c_year", "type": "integer", "original_type": "year(4)", "nullable": true, "default_value": "NULL", "description": "", "ordinal_position": 25, "column_key": ""},
				map[string]any{"name": "c_binary", "type": "binary", "original_type": "binary(16)", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 16, "ordinal_position": 26, "column_key": ""},
				map[string]any{"name": "c_varbinary", "type": "binary", "original_type": "varbinary(255)", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 255, "ordinal_position": 27, "column_key": ""},
				map[string]any{"name": "c_blob", "type": "binary", "original_type": "blob", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 65535, "ordinal_position": 28, "column_key": ""},
				map[string]any{"name": "c_longblob", "type": "binary", "original_type": "longblob", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 4294967295, "ordinal_position": 29, "column_key": ""},
				map[string]any{"name": "c_bit", "type": "boolean", "original_type": "bit(8)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 8, "ordinal_position": 30, "column_key": ""},
				map[string]any{"name": "c_bool", "type": "integer", "original_type": "tinyint(1)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 3, "ordinal_position": 31, "column_key": ""},
				map[string]any{"name": "c_boolean", "type": "integer", "original_type": "tinyint(1)", "nullable": true, "default_value": "NULL", "description": "", "num_precision": 3, "ordinal_position": 32, "column_key": ""},
				map[string]any{"name": "c_null", "type": "string", "original_type": "varchar(20)", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 20, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 33, "column_key": ""},
				map[string]any{"name": "c_not_null", "type": "string", "original_type": "varchar(20)", "nullable": false, "description": "", "char_max_len": 20, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 34, "column_key": ""},
				map[string]any{"name": "c_default", "type": "string", "original_type": "varchar(20)", "nullable": true, "default_value": "'default_value'", "description": "", "char_max_len": 20, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 35, "column_key": ""},
				map[string]any{"name": "c_comment", "type": "string", "original_type": "varchar(20)", "nullable": true, "default_value": "NULL", "description": "这是注释", "char_max_len": 20, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 36, "column_key": ""},
				map[string]any{"name": "c_collate", "type": "string", "original_type": "varchar(20)", "nullable": true, "default_value": "NULL", "description": "", "char_max_len": 20, "charset": "utf8mb4", "collation": "utf8mb4_unicode_ci", "ordinal_position": 37, "column_key": ""},
			},
