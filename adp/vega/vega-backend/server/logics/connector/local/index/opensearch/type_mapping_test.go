...
func TestOpenSearchBuildFieldMappings(t *testing.T) {
	t.Run("open search build field mappings basic types", func(t *testing.T) {
	...
	t.Run("open search build field mappings rejects unsupported feature", func(t *testing.T) {
		connector := &OpenSearchConnector{}
...
func TestOpenSearchConnectorMetadataAndNew(t *testing.T) {
	t.Run("open search connector metadata and new", func(t *testing.T) {
		connector := &OpenSearchConnector{}
