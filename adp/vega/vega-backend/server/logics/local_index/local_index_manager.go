...
// Package local_index manages local indexes generated by BuildTask.
package local_index
...
func (lim *localIndexManager) IndexExists(ctx context.Context, indexName string) (bool, error) {
