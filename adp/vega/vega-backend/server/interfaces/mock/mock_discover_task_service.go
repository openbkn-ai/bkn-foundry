...
func (m *MockDiscoverTaskService) InternalMarkFailed(ctx context.Context, id, message string, finishTime int64) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalMarkFailed", ctx, id, message, finishTime)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDiscoverTaskServiceMockRecorder) InternalMarkFailed(ctx, id, message, finishTime any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
