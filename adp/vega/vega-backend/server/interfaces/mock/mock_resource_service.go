...
func (m *MockResourceService) InternalCreate(ctx context.Context, tx *sql.Tx, req *interfaces.ResourceRequest) (*interfaces.Resource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalCreate", ctx, tx, req)
	ret0, _ := ret[0].(*interfaces.Resource)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockResourceServiceMockRecorder) InternalCreate(ctx, tx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockResourceService) InternalUpdateDiscoveryMetadata(ctx context.Context, tx *sql.Tx, resource *interfaces.Resource, expectedUpdateTime int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalUpdateDiscoveryMetadata", ctx, tx, resource, expectedUpdateTime)
	ret0, _ := ret[0].(error)
	return ret0
}

// InternalUpdateDiscoveryMetadata indicates an expected call of InternalUpdateDiscoveryMetadata.
func (mr *MockResourceServiceMockRecorder) InternalUpdateDiscoveryMetadata(ctx, tx, resource, expectedUpdateTime any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InternalUpdateDiscoveryMetadata", reflect.TypeOf((*MockResourceService)(nil).InternalUpdateDiscoveryMetadata), ctx, tx, resource, expectedUpdateTime)
}
...
// InternalUpdateLocalIndexState mocks base method.
func (m *MockResourceService) InternalUpdateLocalIndexState(ctx context.Context, tx *sql.Tx, id, localIndexStatus, localIndexName, syncMark string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalUpdateLocalIndexState", ctx, tx, id, localIndexStatus, localIndexName, syncMark)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// InternalUpdateLocalIndexState indicates an expected call of InternalUpdateLocalIndexState.
func (mr *MockResourceServiceMockRecorder) InternalUpdateLocalIndexState(ctx, tx, id, localIndexStatus, localIndexName, syncMark any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockResourceService) InternalUpdateSemanticMetadata(ctx context.Context, tx *sql.Tx, resource *interfaces.Resource, expectedUpdateTime int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalUpdateSemanticMetadata", ctx, tx, resource, expectedUpdateTime)
	ret0, _ := ret[0].(error)
	return ret0
}

// InternalUpdateSemanticMetadata indicates an expected call of InternalUpdateSemanticMetadata.
func (mr *MockResourceServiceMockRecorder) InternalUpdateSemanticMetadata(ctx, tx, resource, expectedUpdateTime any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InternalUpdateSemanticMetadata", reflect.TypeOf((*MockResourceService)(nil).InternalUpdateSemanticMetadata), ctx, tx, resource, expectedUpdateTime)
}
...
func (m *MockResourceService) InternalUpdateStatus(ctx context.Context, tx *sql.Tx, id, status, statusMessage string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalUpdateStatus", ctx, tx, id, status, statusMessage)
	ret0, _ := ret[0].(error)
	return ret0
}

// InternalUpdateStatus indicates an expected call of InternalUpdateStatus.
func (mr *MockResourceServiceMockRecorder) InternalUpdateStatus(ctx, tx, id, status, statusMessage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InternalUpdateStatus", reflect.TypeOf((*MockResourceService)(nil).InternalUpdateStatus), ctx, tx, id, status, statusMessage)
}
