...
func (m *MockCatalogAccess) Update(ctx context.Context, tx *sql.Tx, catalog *interfaces.Catalog) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, tx, catalog)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockCatalogAccessMockRecorder) Update(ctx, tx, catalog any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockCatalogAccess)(nil).Update), ctx, tx, catalog)
}
