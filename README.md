...
| **Ontology development platform** (in progress) | BKN Project produces the BKN; BKN Eval and BKN Workshop are peers that open inside a given knowledge network and work on it: |
