...
import (
	...
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/auth"
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/build_task"
	...
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/connector_type"
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/dataset"
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/discover_schedule"
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/discover_task"
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/local_index"
	"github.com/openbkn-ai/bkn-foundry/vega/vega-backend/server/logics/proxy_authorization"
...
func (r *restHandler) RegisterPublic(c *gin.Engine) {
	...
	apiV1.Use(rest.PrivateNoCacheMiddleware(), r.stripProxyInternalHeaders())
	{
		...
		resources := apiV1.Group("/resources")
		{
			...
			resources.POST("/:id/enable", r.EnableResourceByEx)
	...
	apiInV1.Use(rest.PrivateNoCacheMiddleware())
	{
		...
		resources := apiInV1.Group("/resources")
		{
			...
			resources.POST("/:id/enable", r.EnableResourceByIn)
