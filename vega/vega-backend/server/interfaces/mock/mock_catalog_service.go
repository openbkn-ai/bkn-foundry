...
func (m *MockCatalogService) CheckCatalogPermission(ctx context.Context, catalogID string, ops []string, getCatalog bool) (bool, *interfaces.Catalog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckCatalogPermission", ctx, catalogID, ops, getCatalog)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(*interfaces.Catalog)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// CheckCatalogPermission indicates an expected call of CheckCatalogPermission.
func (mr *MockCatalogServiceMockRecorder) CheckCatalogPermission(ctx, catalogID, ops, getCatalog any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckCatalogPermission", reflect.TypeOf((*MockCatalogService)(nil).CheckCatalogPermission), ctx, catalogID, ops, getCatalog)
}
...
func (m *MockCatalogService) InternalGetByID(ctx context.Context, id string, withSensitiveFields bool) (*interfaces.Catalog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InternalGetByID", ctx, id, withSensitiveFields)
	ret0, _ := ret[0].(*interfaces.Catalog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCatalogServiceMockRecorder) InternalGetByID(ctx, id, withSensitiveFields any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCatalogService) ListAuthResourceEntries(ctx context.Context, params interfaces.AuthResourceQueryParams) ([]*interfaces.AuthResourceEntry, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCatalogServiceMockRecorder) ListAuthResourceEntries(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAuthResourceEntries", reflect.TypeOf((*MockCatalogService)(nil).ListAuthResourceEntries), ctx, params)
}

// ListConnectorTypeStats mocks base method.
func (m *MockCatalogService) ListConnectorTypeStats(ctx context.Context, params interfaces.CatalogsQueryParams) ([]*interfaces.CatalogConnectorTypeStat, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListConnectorTypeStats", ctx, params)
	ret0, _ := ret[0].([]*interfaces.CatalogConnectorTypeStat)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListConnectorTypeStats indicates an expected call of ListConnectorTypeStats.
func (mr *MockCatalogServiceMockRecorder) ListConnectorTypeStats(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListConnectorTypeStats", reflect.TypeOf((*MockCatalogService)(nil).ListConnectorTypeStats), ctx, params)
}

// ListPermittedCatalogIDs mocks base method.
func (m *MockCatalogService) ListPermittedCatalogIDs(ctx context.Context, visibilityOperations []string, visibilityMatch string, params interfaces.CatalogsQueryParams) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPermittedCatalogIDs", ctx, visibilityOperations, visibilityMatch, params)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCatalogServiceMockRecorder) ListPermittedCatalogIDs(ctx, visibilityOperations, visibilityMatch, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPermittedCatalogIDs", reflect.TypeOf((*MockCatalogService)(nil).ListPermittedCatalogIDs), ctx, visibilityOperations, visibilityMatch, params)
}

// ListPermittedCatalogIDsWithOperations mocks base method.
func (m *MockCatalogService) ListPermittedCatalogIDsWithOperations(ctx context.Context, visibilityOperations []string, visibilityMatch string, params interfaces.CatalogsQueryParams) ([]string, map[string]interfaces.PermissionResourceOps, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPermittedCatalogIDsWithOperations", ctx, visibilityOperations, visibilityMatch, params)
	ret0, _ := ret[0].([]string)
...
// ListPermittedCatalogIDsWithOperations indicates an expected call of ListPermittedCatalogIDsWithOperations.
func (mr *MockCatalogServiceMockRecorder) ListPermittedCatalogIDsWithOperations(ctx, visibilityOperations, visibilityMatch, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPermittedCatalogIDsWithOperations", reflect.TypeOf((*MockCatalogService)(nil).ListPermittedCatalogIDsWithOperations), ctx, visibilityOperations, visibilityMatch, params)
}

// SetEnabled mocks base method.
func (m *MockCatalogService) SetEnabled(ctx context.Context, id string, enabled bool) (*interfaces.Catalog, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCatalogServiceMockRecorder) SetEnabled(ctx, id, enabled any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetEnabled", reflect.TypeOf((*MockCatalogService)(nil).SetEnabled), ctx, id, enabled)
}
...
func (m *MockCatalogService) Update(ctx context.Context, req *interfaces.CatalogRequest, allowUnhealthy bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, req, allowUnhealthy)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockCatalogServiceMockRecorder) Update(ctx, req, allowUnhealthy any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockCatalogService)(nil).Update), ctx, req, allowUnhealthy)
}
