...
func (m *MockCatalogAccess) ListAuthResourceEntries(ctx context.Context, params interfaces.AuthResourceQueryParams) ([]*interfaces.AuthResourceEntry, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCatalogAccessMockRecorder) ListAuthResourceEntries(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAuthResourceEntries", reflect.TypeOf((*MockCatalogAccess)(nil).ListAuthResourceEntries), ctx, params)
}

// ListConnectorTypePermissionRefs mocks base method.
func (m *MockCatalogAccess) ListConnectorTypePermissionRefs(ctx context.Context, params interfaces.CatalogsQueryParams) ([]interfaces.CatalogConnectorTypePermissionRef, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListConnectorTypePermissionRefs", ctx, params)
	ret0, _ := ret[0].([]interfaces.CatalogConnectorTypePermissionRef)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListConnectorTypePermissionRefs indicates an expected call of ListConnectorTypePermissionRefs.
