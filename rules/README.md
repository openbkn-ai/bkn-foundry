...
- **Documentation layout**: [`docs/api/`](../docs/api) for OpenAPI, [`help/`](../help) manuals (`manual/`) and cookbooks (`cookbook/`) — see [CONTRIBUTING — DOCUMENTATION](CONTRIBUTING.md#documentation)
