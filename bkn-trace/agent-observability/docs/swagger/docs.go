...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/trace-evidence-configuration": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/capturepolicysvc.ConfigurationGetResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Desired state and expected policy revision",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/capturepolicysvc.ChangeRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/rdto.TraceEvidenceConfigurationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/trace-evidence-operations/{operation_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Configuration operation ID",
                        "name": "operation_id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/capturepolicysvc.Operation"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/trace-evidence-operations/{operation_id}:reconcile": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "capturepolicysvc.AdmissionBudget": {
            "type": "object",
            "properties": {
                "contract_version": {
                    "type": "string"
                ...
                "measurements": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/capturepolicysvc.AdmissionMeasurement"
                    }
                },
                "profile": {
                    "type": "string"
        ...
        "capturepolicysvc.AdmissionMeasurement": {
            "type": "object",
            "properties": {
                "fresh": {
                    "type": "boolean"
        ...
        "capturepolicysvc.ChangeRequest": {
            "type": "object",
            "properties": {
                "desired_state": {
                    "enum": [
        ...
        "capturepolicysvc.ConfigurationGetResponse": {
            "type": "object",
            "properties": {
                "active_operation_id": {
                    "type": "string"
                ...
                "admission_budget": {
                    "$ref": "#/definitions/capturepolicysvc.AdmissionBudget"
                },
                "desired_state": {
                    "$ref": "#/definitions/capturepolicysvc.State"
                },
        ...
        "capturepolicysvc.EndpointAcknowledgement": {
            "type": "object",
            "properties": {
                "generation": {
                    "type": "string"
                ...
                "queue_disposition": {
                    "$ref": "#/definitions/capturepolicysvc.QueueDisposition"
                },
                "ready": {
                    "type": "boolean"
                },
                ...
                "state": {
                    "$ref": "#/definitions/capturepolicysvc.AckState"
                }
            }
        },
        "capturepolicysvc.Operation": {
            "type": "object",
            "properties": {
                "error_code": {
                    "type": "string"
                ...
                "phase": {
                    "$ref": "#/definitions/capturepolicysvc.Phase"
                },
                "requested_state": {
                    "$ref": "#/definitions/capturepolicysvc.State"
                }
        ...
        "capturepolicysvc.QueueDisposition": {
            "type": "object",
            "properties": {
                "dropped": {
                    "type": "integer"
        ...
        "rdto.TraceEvidenceConfigurationResponse": {
            "type": "object",
            "properties": {
                "acknowledgements": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/capturepolicysvc.EndpointAcknowledgement"
                    }
                },
                "coverage_gap": {
                    "type": "boolean"
