...
func TestGetArtifactReturnsOnlyArtifactVisibleToScope(t *testing.T) {
	...
	_, found, err = service.GetArtifact(context.Background(), "artifact_query_service", evidencevo.QueryScope{
		AccountID: "other", AccountType: "app",
	})
	if err != nil || found {
...
func TestGetArtifactForAuthorizedInteractionReturnsArtifactToManagedBuilder(t *testing.T) {
	...
	artifact, validationErrors := evidencevo.NormalizeArtifact(evidencevo.EvidenceArtifact{
		ArtifactID:    "artifact_interaction_result",
		ArtifactType:  evidencevo.ArtifactTypeResult,
		RequestID:     "req_interaction_result",
		TraceID:       "4bf92f3577b34da6a3ce929d0e0e4736",
		InteractionID: "int-1",
		ContentType:   "application/json",
		SchemaVersion: evidencevo.ArtifactContractVersion,
		ObservedAt:    "2026-08-07T15:00:00Z",
		Content:       map[string]any{"summary": "库存为 100"},
		AccountID:     "owner",
		AccountType:   "app",
	})
	...
	scope := evidencevo.QueryScope{AccessProfile: &evidencevo.AccessProfile{
		...
		ManagedKnowledgeNetworkIDs: []string{"kn-managed"},
		AccountActive:              true}}
...
func TestGetArtifactReturnsOwnedContentWhenBusinessResolverIsUnavailable(t *testing.T) {
	store := evidencestore.New()
	artifact, validationErrors := evidencevo.NormalizeArtifact(evidencevo.EvidenceArtifact{
		ArtifactID:    "artifact_unresolved_ref_service",
		ArtifactType:  evidencevo.ArtifactTypeDataResult,
		RequestID:     "req_unresolved_ref",
		TraceID:       "4bf92f3577b34da6a3ce929d0e0e4736",
...
func TestGetArtifactReturnsOwnedContentWhenBusinessResolverCannotResolveRef(t *testing.T) {
	store := evidencestore.New()
	artifact, validationErrors := evidencevo.NormalizeArtifact(evidencevo.EvidenceArtifact{
		ArtifactID:    "artifact_missing_resolution_service",
		ArtifactType:  evidencevo.ArtifactTypeDataResult,
		RequestID:     "req_missing_resolution",
		TraceID:       "4bf92f3577b34da6a3ce929d0e0e4736",
		BusinessRefs:  []string{"object:kn_sales:order"},
		ContentType:   "application/json",
		SchemaVersion: evidencevo.ArtifactContractVersion,
...
func TestGetArtifactUsesRecordAuthorizationInsteadOfResolverVisibility(t *testing.T) {
	store := evidencestore.New()
	artifact, validationErrors := evidencevo.NormalizeArtifact(evidencevo.EvidenceArtifact{
		ArtifactID:    "artifact_resolver_guard",
		ArtifactType:  evidencevo.ArtifactTypeDataResult,
		RequestID:     "req_resolver_guard",
		TraceID:       "4bf92f3577b34da6a3ce929d0e0e4736",
...
func TestIngestArtifactRejectsOwnershipDriftFromExistingTrace(t *testing.T) {
	...
	trace := evidencevo.NormalizedTrace{
		...
		Events: []evidencevo.EvidenceEvent{{
			...
			TraceID:   "4bf92f3577b34da6a3ce929d0e0e4736",
			RequestID: "req_existing",
			Payload:   map[string]any{"claim_id": "claim_existing"},
		}},
	}
...
func TestIngestArtifactRejectsTypeThatDoesNotMatchCommittedEventRole(t *testing.T) {
	...
	trace := evidencevo.NormalizedTrace{
		TraceID:       "4bf92f3577b34da6a3ce929d0e0e4736",
		RequestID:     "req_artifact_service",
		AccountID:     "acct_demo",
		AccountType:   "app",
		SchemaVersion: evidencevo.ArtifactContractVersion,
		Events: []evidencevo.EvidenceEvent{{
			EventID:       "evt_question_role",
...
func validArtifactBody(t *testing.T, artifactID string, content any) []byte {
	...
	body, err := json.Marshal(evidencevo.EvidenceArtifact{
		...
		ArtifactType:  evidencevo.ArtifactTypeQuestion,
		RequestID:     "req_artifact_service",
		TraceID:       "4bf92f3577b34da6a3ce929d0e0e4736",
