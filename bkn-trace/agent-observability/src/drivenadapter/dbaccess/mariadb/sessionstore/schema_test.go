...
func TestSchemaFreezesLifecycleAndDurableEvidenceConstraints(t *testing.T) {
	...
	required := []string{
		...
		"bkn_trace_capture_policy_revisions",
		"bkn_trace_producer_instance_registrations",
		"bkn_trace_producer_closure_watermarks",
...
func TestMigrationsAreOrderedAndChecksumProtected(t *testing.T) {
	expectedChecksums := map[string]string{
		...
		"033": "41ebdac4ee2755a5a7f3e85e8f49e9ffc65e0282d60a36195831e6b3c98536ef",
	}
